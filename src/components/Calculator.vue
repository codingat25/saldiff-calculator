...
export default {
  ...
  setup() {
      ...
      const handleSubmit = () => {
        console.log(employeeNumber.value, fName.value, lName.value, mInitial.value, positionTitle.value, dateOfLastProm.value,
                dateFrom.value, dateTo.value, salDiff1.value, periodFrom.value, periodTo.value, salDiff2.value, sdBonus.value, grossSalDiff.value, gsis.value, 
                lessGsis.value, withholdingtax.value, totalDeduct.value, netAmount.value)
      }
